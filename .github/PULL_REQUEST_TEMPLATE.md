...
3. **E2E 테스트/시각적 회귀테스트**: 핵심 사용자 워크플로우 검증
   ...
   - **CI/CD 비용 절감 고려**: E2E 테스트는 실제 API를 호출하는 형태이기 때문에 매 CI/CD마다 E2E가 계속 실행되면 API 호출 리소스가 낭비되고 실행 속도도 느려집니다. 따라서 E2E 테스트는 핵심 워크플로우에만 집중하고, 세부적인 기능 검증은 통합 테스트로 커버하는 전략을 선택했습니다.
...
1. **반복 일정 부분 수정 검증**
   ...
   - [커밋 링크](https://github.com/hanghae-plus/front_7th_chapter1-3/pull/14/commits/735fa50f0083298b93d4587efc954e30f54f328e)

2. **반복 일정 전체 수정 검증**

   - 모든 반복 일정 수정 시 해당하는 전체 반복 일정이 수정되었는지 확인
   - [커밋 링크](https://github.com/hanghae-plus/front_7th_chapter1-3/pull/12/commits/cead1431c0075f8ab938c6234074b0a054129555)

3. **입력 폼 상태 관리 검증**
   - 입력 폼이 입력된 상태에서 캘린더 날짜 클릭 시 폼의 날짜 변경 동작 확인
   - 사용자 경험 관점의 상태 관리 검증
   - [커밋 링크](https://github.com/hanghae-plus/front_7th_chapter1-3/pull/27/commits/7619852c45e1b9bf06a8ef064c64f656efdb9ec7) 
...
4. **날짜 클릭 시 폼 채우기 검증**
   ...
   - [커밋 링크](https://github.com/hanghae-plus/front_7th_chapter1-3/pull/47/commits/dc58b4ab088b99b7929c09848611bacbefd1c868)
...
5. **날짜 관련 엣지 케이스 검증**
   ...
   - [커밋 링크](https://github.com/joshuayeyo/hh-week3/pull/2)
   ![1762519948118](image/PULL_REQUEST_TEMPLATE/1762519948118.png)

6. **뷰 전환 동작 검증**
   - 뷰(월별 ↔ 주별) 변경 시 해당 월의 1주차로 이동되는지 확인
   - [커밋 링크](https://github.com/hanghae-plus/front_7th_chapter1-3/pull/47/commits/5b4587e4c643d581e96882974871405dad41ef00)
...
7. **드래그 앤 드롭 동작 검증**
   ...
   - [커밋 링크](https://github.com/1lmean/front_7th_chapter1-3/commit/ae66bc874193bfcc0a7a6449ba072a363b6d8b56)
...
9. **알림 표시 동적 업데이트**
   ...
   - [커밋 링크](https://github.com/hanghae-plus/front_7th_chapter1-3/pull/47/commits/5664aaa7bbf6d4a664cdbc8452774dd38bffe648)
